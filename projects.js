...
const PROJECTS = [
  ...
  },
  {
    ...
    description: "This internship gave me experience in Radiation Effects from a Systems Engineering perspective, with responsibilities spanning the design of test plans and test boards for semiconductor devices for TID, FXR, and neutron-induced displacement damage (nDD) effects. I was also able to run some simulations of Linear Energy Transfer (LET) at different orbits using CREME96 and OMERE simulation, and run unit conversions in Excel. Another project I got to work on was about sensorless motor control; the task was to research and design a dynamics model using MATLAB. I was more on the research side, using breadboards to test sensorless control algorithms such as Back EMF Zero Crossings, and I used a commercial board to test Field Oriented Control (FOC). To really understand the PN Junction and semiconductors, I also got to order different Zener diodes and used a Source Measurement Unit (SMU) to graph the IV characteristic in excel and, graph the line of best fit, and also calculate the exponential current-voltage equation. *I have put together some slides showing how radiation affects the PN junction. The PDF of the slides will be downloaded when you click the link button.*",
